...
var SliderCinematic = ({ apiKey, showcaseMode = false, onSuccess, onError } = {}) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex flex-col items-center gap-8", children: /* @__PURE__ */ jsx("div", { className: "relative group w-full max-w-lg", children: /* @__PURE__ */ jsxs("div", { className: "bg-black px-6 py-8 rounded-[2rem] border border-zinc-800 shadow-2xl relative overflow-hidden", children: [
    /* @__PURE__ */ jsx(
      motion.div,
      {
        layoutId: "spotlight",
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center mb-8 px-2", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
        /* @__PURE__ */ jsx("span", { className: "text-zinc-500 text-xs font-medium uppercase tracking-wider", children: "Likelihood" }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: `text-3xl font-bold transition-colors duration-300 ${activeColor}`, children: displayValue }),
          /* @__PURE__ */ jsx("span", { className: "text-zinc-600 text-sm", children: "/ 10" })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: `w-10 h-10 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center transition-colors duration-300 ${activeColor}`, children: displayValue <= 4 ? /* @__PURE__ */ jsx(Shield, { size: 18 }) : displayValue <= 7 ? /* @__PURE__ */ jsx(Minus, { size: 18 }) : /* @__PURE__ */ jsx(Star, { size: 18, fill: "currentColor", className: "opacity-50" }) })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "relative flex justify-between items-center z-10", children: RANGE.map((num) => {
      ...
      return /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            (isActive || isHovered) && /* @__PURE__ */ jsx(
              motion.div,
              {
                layoutId: "lens-ring",
            ...
            /* @__PURE__ */ jsx("span", { className: `text-sm font-bold relative z-20 transition-all duration-300 ${isActive ? "text-white scale-125" : isHovered ? "text-zinc-300 scale-110" : "text-zinc-600"}`, children: num }),
            isActive && num >= 8 && /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx(
                motion.div,
                {
    ...
    /* @__PURE__ */ jsx("div", { className: "mt-8 w-full h-px bg-gradient-to-r from-transparent via-zinc-800 to-transparent" }),
    /* @__PURE__ */ jsx(
      "button",
      {
