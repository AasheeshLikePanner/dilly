...
var EmojiInteractive = ({
  ...
  return /* @__PURE__ */ jsx(AnimatePresence, { children: isOpen && /* @__PURE__ */ jsx("div", { className: "fixed bottom-6 right-6 z-50 flex flex-col items-end", children: /* @__PURE__ */ jsxs(
    motion.div,
    {
      layout: true,
