...
var EmojiSoul = ({
  ...
  return /* @__PURE__ */ jsx(AnimatePresence, { children: isOpen && /* @__PURE__ */ jsx("div", { className: "fixed bottom-6 right-6 z-50 flex flex-col items-center justify-center gap-4", children: /* @__PURE__ */ jsxs(
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-black relative w-full max-w-md rounded-[2rem] border border-zinc-800 p-1 overflow-hidden shadow-2xl", children: [
