...
var EmojiSoul = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_framer_motion.AnimatePresence, { children: isOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fixed bottom-6 right-6 z-50 flex flex-col items-center justify-center gap-4", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    import_framer_motion.motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "bg-black relative w-full max-w-md rounded-[2rem] border border-zinc-800 p-1 overflow-hidden shadow-2xl", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 opacity-30 transition-colors duration-700 ease-in-out bg-[radial-gradient(circle_at_50%_0%,rgba(255,255,255,0.1),transparent_70%)]" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_framer_motion.AnimatePresence, { children: selected && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_framer_motion.motion.div,
            {
              initial: { opacity: 0 },
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "relative z-10 bg-zinc-900/80 backdrop-blur-sm rounded-[1.8rem] p-8 text-center", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "text-white font-medium text-xl mb-8 tracking-tight", children: "How was the quality?" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "flex justify-between items-center px-2", children: FEEDBACK_OPTIONS.map((option) => {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mt-10 h-8", children: selected && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
