...
var SliderCrystal = ({ apiKey, showcaseMode = false, onSuccess, onError } = {}) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex flex-col items-center gap-8", children: /* @__PURE__ */ jsxs(
    "div",
    {
      className: "bg-black/50 backdrop-blur-md p-8 rounded-[2.5rem] border border-white/5 shadow-2xl",
      onMouseLeave: () => setHoverLevel(0),
      children: [
        /* @__PURE__ */ jsx("div", { className: "flex gap-2 mb-8", children: RANGE.map((val) => {
          ...
          return /* @__PURE__ */ jsxs(
            motion.button,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-white/10 to-transparent pointer-events-none" })
              ]
            },
            val
          );
        }) }),
        /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center h-12 px-2", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
            /* @__PURE__ */ jsx("span", { className: "text-[10px] text-zinc-500 uppercase tracking-widest font-bold mb-1", children: "Your Rating" }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-1", children: [
              /* @__PURE__ */ jsx("span", { className: "text-3xl font-bold text-white leading-none", children: hoverLevel || level }),
              /* @__PURE__ */ jsx("span", { className: "text-zinc-600 text-sm font-medium", children: "/ 10" })
            ] })
          ] }),
          /* @__PURE__ */ jsxs(AnimatePresence, { children: [
            level > 0 && !submitted && /* @__PURE__ */ jsx(
              motion.button,
              {
                ...
                children: isSubmitting ? /* @__PURE__ */ jsx(Sparkles, { size: 20, className: "animate-spin" }) : /* @__PURE__ */ jsx(ArrowRight, { size: 24, strokeWidth: 2.5 })
              }
            ),
            submitted && /* @__PURE__ */ jsx(
              motion.div,
              {
                ...
                children: /* @__PURE__ */ jsx(Check, { size: 24, strokeWidth: 3 })
              }
            )
          ] })
        ] })
