...
var BugReporter = ({ apiKey, showcaseMode = false, onSuccess, onError } = {}) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex flex-col items-center justify-center gap-6", children: /* @__PURE__ */ jsxs(
    motion.div,
    {
      layout: true,
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "p-6 space-y-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
            /* @__PURE__ */ jsx("div", { className: "p-2.5 rounded-xl bg-red-500/20 text-red-400", children: /* @__PURE__ */ jsx(Bug, { size: 18 }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("span", { className: "block text-sm font-semibold text-white tracking-tight", children: "Report a Bug" }),
              /* @__PURE__ */ jsx("span", { className: "block text-[10px] text-zinc-500 font-medium uppercase tracking-wider", children: "Help us improve" })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { htmlFor: "bug-title", className: "sr-only", children: "Bug Title" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "text",
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { htmlFor: "bug-description", className: "sr-only", children: "Bug Description" }),
            /* @__PURE__ */ jsx(
              "textarea",
              {
                id: "bug-description",
          ...
          /* @__PURE__ */ jsx(
            ...
            `,
              disabled: isDisabled,
              children: /* @__PURE__ */ jsx(AnimatePresence, { mode: "wait", children: status === "sending" ? /* @__PURE__ */ jsxs(
                motion.span,
                {
                  initial: { opacity: 0 },
                  animate: { opacity: 1 },
                  ...
                  children: [
                    /* @__PURE__ */ jsx(Bug, { size: 16, className: "animate-spin" }),
                ...
                motion.span,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx("span", { children: "Submit Bug Report" })
                  ]
                },
                "idle"
              ) })
