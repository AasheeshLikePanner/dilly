...
export const VariantShapeShifter = ({ apiKey, showcaseMode = false, onSuccess, onError }: SliderReactionProps = {}) => {
...
export const VariantCinematic = ({ apiKey, showcaseMode = false, onSuccess, onError }: SliderReactionProps = {}) => {
...
export const VariantCrystal = ({ apiKey, showcaseMode = false, onSuccess, onError }: SliderReactionProps = {}) => {
