...
export const VariantDock = ({ apiKey, showcaseMode = false, onSuccess, onError }: EmojiReactionProps = {}) => {
...
export const VariantSoul = ({ apiKey, showcaseMode = false, onSuccess, onError }: EmojiReactionProps = {}) => {
  const [selected, setSelected] = useState<number | null>(null);
  const [isSubmitting, setIsSubmitting] = useState(false);
...
export const VariantInteractive = ({ apiKey, showcaseMode = false, onSuccess, onError }: EmojiReactionProps = {}) => {
