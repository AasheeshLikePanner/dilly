...
const MOCK_BUGS: Bug[] = [
  {
    ...
    workspace_id: "ws_88293",
    assigned_to: "usr_1",
    profiles: { id: "usr_1", full_name: "Alex Rivera", email: "alex@dev.co" },
    title: "Checkout crashes on Safari Mobile when using Apple Pay",
    description: "Steps to reproduce: 1. Add item to cart. 2. Select Apple Pay. 3. Observer crash. Error logs attached in media.",
    type: "bug",
    priority: "critical",
    status: "qa_failed",
    media: [{ type: "image", url: "/mock/crash.png" }, { type: "log", url: "/mock/error.log" }],
    tags: ["checkout", "mobile", "safari"],
  ...
  },
  {
    ...
    workspace_id: "ws_88293",
    assigned_to: "usr_2",
    profiles: { id: "usr_2", full_name: "Mike Chen", email: "mike@design.io" },
    title: "Update dashboard typography to Inter",
    description: "We need to replace Roboto with Inter across the entire analytics dashboard to match the new brand guidelines.",
    type: "ui",
    priority: "medium",
    status: "in_progress",
    media: [],
    ...
    created_by: "DesignLead"
  },
  {
    id: "c99de56f-78gh-9012-i345-6j78k90l12m3",
    workspace_id: "ws_88293",
    assigned_to: null,
    profiles: null,
    title: "Database query timeout on large exports",
    description: null,
    type: "performance",
    priority: "high",
    status: "needs_info",
...
export default function BugsPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <div className="p-4">
      ...
      <div className="mt-8">
        <IssuesTable workspaceSlug={slug} />
      </div>
    </div>
  );
}